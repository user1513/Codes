...
void USART3_IRQHandler(void)                	//串口3中断服务程序
{
	if(USART_GetITStatus(USART3,USART_IT_RXNE)!= RESET)
	{
		...
		Usart3_array[Usart3_Num]=USART_ReceiveData(USART3);
		if(uart3flag==TRUE)
		{
			switch(Usart3_Num)
			{
				case 0:if(Usart3_array[Usart3_Num] == 0X55) Usart3_Num++;else Usart3_Num=0;break;
				case 1:if(Usart3_array[Usart3_Num] == 0XAA) Usart3_Num++;else Usart3_Num=0;break;
				case 2:
				case 3:
				case 4:
				case 5:Usart3_Num++;break;
				case 6:
					if(Usart3_array[Usart3_Num]==0XFF)
					{
						Receivebufferarea[0]++;
						MyStrncpy((char *)(Receivebufferarea+ReceivebufferareaVal),(const char *)Usart3_array,7); 
						Usart3_Num=0;
						ReceivebufferareaVal +=7;
					}
					else 
						Usart3_Num=0;
					break;
				default :Usart3_Num=0;break;
			}
		}
	}
}
