...
{      
    ...
    { 
        RTC_Set_Time(20,40,0,RTC_HOURFORMAT12_PM);	        //设置时间 ,根据实际时间修改
		RTC_Set_Date(19,3,13,3);		                    //设置日期
...
{ 
    ...
    HAL_NVIC_SetPriority(RTC_Alarm_IRQn,0x08,0x00); //抢占优先级1,子优先级2
...
{ 
    ...
    HAL_NVIC_SetPriority(RTC_WKUP_IRQn,0x08,0x00); //抢占优先级1,子优先级2
