...
void SendListInit(u8 _num,u16 _firstaddr1,u16 _firstaddr2,u16 _firstaddr3)//代表發送多少組數據
{
	while(_num--)
	{
		Send_China_Data(_firstaddr1,"空");
		_firstaddr1 +=2;
		delay_ms(10);
		Send_China_Data(_firstaddr2,"空");
		_firstaddr2 +=2;
		delay_ms(10);
		Send_China_Data(_firstaddr3,"空");
		_firstaddr3 +=2;
		delay_ms(10);
	}
}
