...
#define BUFFERSIZE 		1  //设置DMA缓冲区长度
#define NbrOfChannel 	1  //设置ADC通道个数
//初始化ADC
//这里我们仅以规则通道为例
//我们默认将开启通道0~3																	   
void  Adc_Init(void)
{ 	
	...
	DMA_InitTypeState.DMA_BufferSize= BUFFERSIZE;
	...
	ADC_InitStructure.ADC_NbrOfChannel = NbrOfChannel;	//顺序进行规则转换的ADC通道的数目
