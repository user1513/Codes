...
#define FDCt_SDA_IN()  {GPIOB->CRH&=0XF0FFFFFF;GPIOB->CRH|=(u32)8<<24;}
#define FDCt_SDA_OUT() {GPIOB->CRH&=0XF0FFFFFF;GPIOB->CRH|=(u32)3<<24;}


//IO操作函数	 
#define FDCt_IIC_SCL    PBout(13) 	//SCL
#define FDCt_IIC_SDA    PBout(14)   //输出SDA	 
#define FDCt_READ_SDA   PBin(14) 		//输入SDA 
