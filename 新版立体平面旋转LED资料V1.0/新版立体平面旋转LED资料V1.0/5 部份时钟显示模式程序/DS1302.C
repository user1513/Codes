...
uchar code starts_time[7]={0x00,0x10,0x22,0x20,0x05,0x04,0x15};	 //初始化后设置
uchar  Sec;
uchar  Cent;
uchar  Hour;
uchar  Year;
...
void Set(uchar sel,uchar sel_1) 
{
 ...
 if(sel==3)  {address=0x80; max=59;min=0;}    //秒
...
void du1302P()
{
	  ...
	  Month=R1302(0x89);//月
	  TimeBuff[15]=Month/16;
	  TimeBuff[14]=Month%16;
	  TimeBuff[12]=11;//月字左边
	  TimeBuff[13]=12;//月字右边
