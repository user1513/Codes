...
* @{
*/
#define PRODUCT_KEY "bbdab73c651d472a9b509c2386fe6d99"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "b0ca3250dafb4602a5b302d4d85972b3"
...
* @{
*/
#define Time_BYTEOFFSET                    0
#define Time_BITOFFSET                     0
#define Time_LEN                           4
...
#define Gas_MIN                           0
#define Gas_MAX                           4096
#define Heart_Rate_RATIO                         0.1
#define Heart_Rate_ADDITION                      0
#define Heart_Rate_MIN                           0
#define Heart_Rate_MAX                           1500
/**@} */
...
typedef enum
{
    ...
    Time_VALUE8 = 8,//2小时
    Time_VALUE9 = 9,//4小时
    Time_VALUE10 = 10,//12小时
    Time_VALUE11 = 11,//24小时
    Time_VALUE_MAX,
} Time_ENUM_T;
