...
* @{
*/
#define PRODUCT_KEY "57588223415c470c810d2286c9af71d0"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "2d1f6e3db3334fb4bbc0d639b5b95da0"
...
#define soilhum_RATIO                         1
#define soilhum_ADDITION                      0
#define soilhum_MIN                           0
#define soilhum_MAX                           255
#define EnvironmentalScienceHum_RATIO                         1
#define EnvironmentalScienceHum_ADDITION                      0
#define EnvironmentalScienceHum_MIN                           0
#define EnvironmentalScienceHum_MAX                           100
#define EnvironmentalScienceTemp_RATIO                         1
#define EnvironmentalScienceTemp_ADDITION                      0
#define EnvironmentalScienceTemp_MIN                           0
#define EnvironmentalScienceTemp_MAX                           100
#define signal_RATIO                         1
#define signal_ADDITION                      0
#define signal_MIN                           0
#define signal_MAX                           20
#define light_RATIO                         1
#define light_ADDITION                      0
#define light_MIN                           0
#define light_MAX                           65536
/**@} */
...
typedef struct {
  bool valuemotor;
  uint32_t valuesoilhum;
  uint32_t valueEnvironmentalScienceHum;
  uint32_t valueEnvironmentalScienceTemp;
  uint32_t valuesignal;
  uint32_t valuelight;
} dataPoint_t;
...
typedef struct {
  uint8_t wBitBuf[COUNT_W_BIT];
  uint8_t valuesoilhum;
  uint8_t valueEnvironmentalScienceHum;
  uint8_t valueEnvironmentalScienceTemp;
  uint8_t valuesignal;
  uint32_t valuelight;
} devStatus_t; 
